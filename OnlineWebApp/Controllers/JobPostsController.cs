...
namespace OnlineWebApp.Controllers
{
    public class JobPostsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PostID,JobPosition,Qualification,JobDescription,Experience,Age,AppProcess")] JobPost jobPost)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PostID,JobPosition,Qualification,JobDescription,Experience,Age,AppProcess")] JobPost jobPost)
        {
            if (ModelState.IsValid)
            {
